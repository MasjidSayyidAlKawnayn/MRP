...
6. `student_school_year_integer.sql`
7. `student_primary_parent_phone.sql`
8. `student_google_form_fields.sql`
9. `optional_teacher_group.sql`
10. `fix_attendance_rls.sql`
11. `fix_cohort_rls.sql`
12. `secure_admin_rls.sql`
13. `user_onboarding_state.sql`
